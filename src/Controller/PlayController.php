...
class PlayController extends AbstractController
{
    ...
    public function __construct(Security $security, RunRepository $emr, ResultRepository $emrt, AthleteRepository $ema, ShotRepository $ems, ZoneRepository $emz, EntityManagerInterface $manager)
    {
    ...
    {
        $play = new GoPlay($this->ema, $this->ems, $this->emz, $this->emrt, $this->manager);
        $run = $this->emr->find($run->getId());
